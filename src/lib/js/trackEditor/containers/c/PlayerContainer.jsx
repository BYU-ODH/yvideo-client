...
const PlayerContainer = props => {
	...
	useEffect(() => {
		if (!contentCache[contentId]) getContent([contentId])
		else setContent(contentCache[contentId])
	...
	}, [addView, content, contentCache, contentId, getContent, getResources, resource, resourceCache])
