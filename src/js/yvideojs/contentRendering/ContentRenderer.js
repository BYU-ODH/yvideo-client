...
const ContentRenderer = (() => {
	...
	setupTranslatorPane = (tab, player, content, resourceMap) => {
	...
	setupTranscriptPane = (tab, player, content, trackResources, trackMimes) => {
